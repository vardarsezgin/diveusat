...
import 'news_from_underwater_model.dart';
export 'news_from_underwater_model.dart';

class NewsFromUnderwaterWidget extends StatefulWidget {
  const NewsFromUnderwaterWidget({
    Key? key,
    this.notId,
  }) : super(key: key);
  ...
  @override
  _NewsFromUnderwaterWidgetState createState() =>
      _NewsFromUnderwaterWidgetState();
}

class _NewsFromUnderwaterWidgetState extends State<NewsFromUnderwaterWidget> {
  late NewsFromUnderwaterModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NewsFromUnderwaterModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'newsFromUnderwater'});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: InkWell(
          onTap: () async {
            logFirebaseEvent('NEWS_FROM_UNDERWATER_Icon_yyr7gqc5_ON_TA');
        ...
        actions: [
          Padding(
            ...
            child: InkWell(
              onTap: () async {
                logFirebaseEvent('NEWS_FROM_UNDERWATER_Row_etv76a8p_ON_TAP');
                logFirebaseEvent('Row_backend_call');

                final newsCreateData = {
                ...
                await NewsRecord.collection.doc().set(newsCreateData);
                        ...
                        child: Row(
                          ...
                          children: [
                            InkWell(
                              onTap: () async {
                                logFirebaseEvent(
                                    'NEWS_FROM_UNDERWATER_post_image_ON_TAP');
                                logFirebaseEvent(
                        ...
                        child: Row(
                          ...
                          children: [
                            InkWell(
                              onTap: () async {
                                logFirebaseEvent(
                                    'NEWS_FROM_UNDERWATER_post_video_ON_TAP');
                                logFirebaseEvent(
