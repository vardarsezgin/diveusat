...
import 'new_dive_model.dart';
export 'new_dive_model.dart';

class NewDiveWidget extends StatefulWidget {
  const NewDiveWidget({Key? key}) : super(key: key);

  @override
  _NewDiveWidgetState createState() => _NewDiveWidgetState();
}

class _NewDiveWidgetState extends State<NewDiveWidget> {
  late NewDiveModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NewDiveModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'newDive'});
                        ...
                        child: Row(
                          ...
                          children: [
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'NEW_DIVE_arrow_back_rounded_ICN_ON_TAP');
                          ...
                          children: [
                            Padding(
                              ...
                              child: InkWell(
                                onTap: () async {
                                  logFirebaseEvent(
                                      'NEW_DIVE_PAGE_Container_p0m955s5_ON_TAP');
                                  logFirebaseEvent(
                      ...
                      child: Wrap(
                        ...
                        children: [
                          ...
                          InkWell(
                            onTap: () async {
                              logFirebaseEvent(
                                  'NEW_DIVE_PAGE_Container_arg69gpt_ON_TAP');
                              ...
                              final tripsCreateData = {
                                ...createTripsRecordData(
                                  ...
                                  eventType: _model.radioButtonValue,
