...
class SinglePostPageWidget extends StatefulWidget {
  ...
  @override
  _SinglePostPageWidgetState createState() => _SinglePostPageWidgetState();
}
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: FlutterFlowIconButton(
          ...
          onPressed: () async {
            logFirebaseEvent('SINGLE_POST_arrow_back_rounded_ICN_ON_TA');
      ...
      body: StreamBuilder<NotificationsRecord>(
        stream: NotificationsRecord.getDocument(widget.postId!),
        builder: (context, snapshot) {
          ...
          final columnNotificationsRecord = snapshot.data!;
          return Column(
                    ...
                    children: [
                            ...
                            child: ClipRRect(
                              ...
                              child: Image.network(
                                valueOrDefault<String>(
                                  columnNotificationsRecord.image,
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Text(
                              columnNotificationsRecord.header!
                                  .maybeHandleOverflow(
                                maxChars: 70,
                                replacement: '…',
                              ),
                            ...
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent(
                                    'SINGLE_POST_trashAlt_ICN_ON_TAP');
                      ...
                      if (columnNotificationsRecord.video != null &&
                          columnNotificationsRecord.video != '')
                        Align(
                          alignment: AlignmentDirectional(0.0, 0.0),
                          child: Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                            ...
                            child: Container(
                              ...
                              child: Padding(
                                ...
                                child: FlutterFlowVideoPlayer(
                                  path: columnNotificationsRecord.video!,
