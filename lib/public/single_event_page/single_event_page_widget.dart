...
class _SingleEventPageWidgetState extends State<SingleEventPageWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'singleEventPage'});
                            ...
                            child: Row(
                              ...
                              children: [
                                FlutterFlowIconButton(
                                  ...
                                  onPressed: () async {
                                    logFirebaseEvent(
                                        'SINGLE_EVENT_arrow_back_rounded_ICN_ON_T');
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      FlutterFlowIconButton(
                                        ...
                                        onPressed: () async {
                                          logFirebaseEvent(
                                              'SINGLE_EVENT_trashAlt_ICN_ON_TAP');
                                          logFirebaseEvent(
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: InkWell(
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'SINGLE_EVENT_Container_b8yctb01_ON_TAP');
                                      logFirebaseEvent(
                                  ...
                                  child: Container(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Text(
                                            columnEventsRecord.organizator!,
                                            style: FlutterFlowTheme.of(context)
                                                .title2
                                                .override(
                                                  fontFamily: 'Roboto',
